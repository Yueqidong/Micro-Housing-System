  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        ...
        <ul class="nav-menu">
          <li class="menu-active"><a href="reviewApplication.php">Go back</a></li>
    ...
    <section id="contact" class="section-bg wow fadeInUp">
      <div class="container">
		...
		echo"<td>{$v[2]}</td>";
		echo"<td>{$v[3]}</td>";
		echo"<td><a href='selectApplicant.php?c={$v[0]}'  type='button' class='btn btn-primary' onclick='return confirm('Are you sure?')'>Select</a></td>";
        echo"</tr>";
		}
		?>
