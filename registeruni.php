          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
					<form name="myForm" method="post" action="registerUniProcess.php">
					  <label style="color:white">University Name:</label><br>
					  <input type="text" name="uniname" class="form-control" name="uniname" required><br>
					  
					  <label style="color:white">User Name:</label><br>
					  <input type="text" name="username" class="form-control" name="username" required><br>
									
					  <label style="color:white">Password:</label><br>
					  <input type="password" name="password" class="form-control" name="password" required><br>
					  
					  <label style="color:white">Admin Name:</label><br>
					  <input type="text" name="adminname" class="form-control" name="adminname" required><br>
					  
					  <label style="color:white">Email:</label><br>
					  <input type="email" name="email" class="form-control" name="email"><br>
