...
$query = "select programme.programmeID, programmeName, closingDate, COUNT(applicantID) as number from application, programme where programme.programmeID= application.programmeID group by programmeName";
  ...
  <header id="header">
    <div class="container-fluid">
	  ...
	  <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li class="menu-active"><a href="universityAdminPage.php">Go back</a></li>
		  ...
		  foreach($attr as $v)
    {
		...
		echo"<td>{$v[2]}</td>";
		echo"<td>{$v[3]}</td>";
		echo"<td><a href='select.php?c={$v[0]}'  type='button' class='btn btn-primary' >Select</a></td>";
        echo"</tr>";
    }
