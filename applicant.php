  ...
  <header id="header">
    ...
    <section id="contact" class="section-bg wow fadeInUp">
      <div class="container">
		...
		echo"<td>{$v[5]}</td>";
		echo"<td>{$v[6]}</td>";
		echo"<td><form action='saveStatus.php' method='POST'><select name='status'>";
		echo"<option value ='successful'>Successful</option><option value = 'unsuccessful'>Unsuccessful</option><option value='pending'>Pending</option>";
		echo"</select></td>";
		echo"<td><input type='submit' value='Save' class='btn btn-primary'></form></td>";
        echo"</tr>";
		}
		?>
